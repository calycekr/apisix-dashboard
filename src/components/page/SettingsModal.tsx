...
const AdminKey = () => {
  ...
  return (
    <div>
      ...
      <Typography.Text type="secondary" style={{ display: 'block', marginBottom: 8, fontSize: 'var(--app-font-size-md)' }}>
...
const UICommitSha = () => {
  return (
    <div>
      ...
      <Typography.Text type="secondary" style={{ fontSize: 'var(--app-font-size-base)' }}>
        {sha}
      </Typography.Text>
    </div>
  );
