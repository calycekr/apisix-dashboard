...
export type APISIXType = RawAPISIXType & {
  ...
  >;
  RespPluginMetadataList: AxiosResponse<
    APISIXListResponse<{ value: APISIXType['PluginMetadata']; key: string }>
  >;
  RespPluginMetadataItem: APISIXType['RespPluginMetadataList']['data']['list'][number];
